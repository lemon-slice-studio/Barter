...
public abstract class NormalContainerTileEntity extends TileEntity implements INamedContainerProvider
{
    ...
    public void refresh()
    {
        if (this.hasWorld() && !this.world.isRemote && !prepareForRemove)
        {
            ...
            this.world.markAndNotifyBlock(pos, world.getChunkAt(pos), state, state, 11, 512);
    ...
    {
        return new TranslationTextComponent("container.barter." + getType().getRegistryName().getPath());
    }
}
